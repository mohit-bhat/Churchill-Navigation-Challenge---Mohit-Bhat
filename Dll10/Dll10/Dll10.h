...
// from a DLL simpler. All files within this DLL are compiled with the DLL10_EXPORTS
// symbol defined on the command line. This symbol should not be defined on any project
// that uses this DLL. This way any other project whose source files include this file see 
// DLL10_API functions as being imported from a DLL, whereas this DLL sees symbols
// defined with this macro as being exported.
#ifdef DLL10_EXPORTS
#define DLL10_API __declspec(dllexport)
#else
#define DLL10_API __declspec(dllimport)
#endif
