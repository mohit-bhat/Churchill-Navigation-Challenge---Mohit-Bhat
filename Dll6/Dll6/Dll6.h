...
// from a DLL simpler. All files within this DLL are compiled with the DLL6_EXPORTS
// symbol defined on the command line. This symbol should not be defined on any project
// that uses this DLL. This way any other project whose source files include this file see 
// DLL6_API functions as being imported from a DLL, whereas this DLL sees symbols
// defined with this macro as being exported.
#ifdef DLL6_EXPORTS
#define DLL6_API __declspec(dllexport)
#else
#define DLL6_API __declspec(dllimport)
#endif
...
node * search(node * n, int32_t count, float xymin, float xymax, Point* out_points);